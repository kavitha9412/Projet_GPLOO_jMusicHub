...
public class AudioBook extends AudioElement {
	...
	private static Logger logger = Logger.getLogger(AudioBook.class);
	
	private Language language;
	private Category category;

	
	public AudioBook(String title, String artist, int lengthInSeconds, String uid, String content, String language,
			String category) {
	...
	public AudioBook(String title, String artist, int lengthInSeconds, String content, String language,
			String category) {
