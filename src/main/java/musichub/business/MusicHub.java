...
//Création de la classe SortByDate pour trier l'album par date
...
//Création d'une classe pour trier les albums par genre
...
//Création d'une classe pour trier les albums par auteur
...
public class MusicHub implements Serializable {
	...
	// Déclaration des variables qui contiennent les valeurs
	...
	// Création de l'objet XMLHandler
	...
	public List<PlayList> getPlayListAsList() {
		return playlists;
	}
	...
	public void deletePlayList(String playListTitle) throws NoPlayListFoundException {
		...
		// Boucle pour itérer les playlist
		...
		if (!result)
			//Lancer l'exception si la playlist n'est pas trouvée
	...
	// Méthode pour obtenir la liste des albums
	...
	// Méthode pour obtenir la liste des audio book
	...
	// Méthode pour obtenir les chansons d'un album
	...
	// Méthode pour obtenir des albums triés par genre
	...
	public void addElementToAlbum(String elementTitle, String albumTitle)
		...
		if (found == true) {
			...
			if (theElement != null) {
				...
				// remplacer l'album dans la liste
	...
	// Méthode pour ajouter un élément à la playlist
	...
	// 
	// Méthode pour charger les albums
	...
	// Methode pour charger les playlists
	...
	// Methode pour charger les éléments
	...
	// Méthode pour sauvegarder les albums
	...
	// Methode pour sauvegarder les playlist
	public void savePlayLists() {
		...
		// ssauvegarder toutes les playlist
	...
	// Methode pour sauvegarder les éléments
	public void saveElements() {
		...
		// sauver tout les éléments audio
